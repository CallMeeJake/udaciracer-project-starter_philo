...
function runRace(raceID) {
	...
	const raceInterval = setInterval(async (res) => {
		try {
			const res = await getRace(raceID)
			let raceStatus = res.status
    /* 
	...
	*/
	...
	// remember to add error handling for the Promise
			...
			console.log(`Problem running interval --> runRace: ${error}`)
...
function handleAccelerate() {
	...
	.then(() => console.log("Acceleration request sent successfully!"))
